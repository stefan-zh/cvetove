...
$issue = $_GET['issue'];
$query = mysql_query("Select * from `$mysql_table` where `cat` = 'fiction' and `issue` = '$issue' order by `id` DESC");
...
$info .= "<div id='full-box-header'>$name</div>
	<div id='full-box'><img src='$img' width='285' height='220' class='pic'>$text</b></i></u>... &nbsp;
		<a href='index.php?q=$q&opt=$id&issue=$issue&method=full' class='text-head'>[чети още]</a><br /><br /></div>
		<div id='info'>
...
<?php echo($err); ?>
  <tr>
    <td><div id="main-head" style="width:920px;">Проза</div></td>
  </tr>
  <tr>
    <td>
