...
$main = $row['main'];
if($main == '1') { $message = "[статията е главна]"; }
else { $message = "" ; }

$info .= "<div id='main-box-header'>$name <div class='boom'>$message</div></div>
	<div id='main-box'><img src='../$img' width='285' height='220' class='pic'>$text</b></i></u>... &nbsp;
		<a href='admin.php?q=$q&opt=$id&method=full&issue=$issue' class='text-head'>[чети още]</a><br /><br /></div>
		<div id='box'>
...
<?php echo($err); ?>
  <tr>
    <td><div id="main-head">Журнал</div></td>
  </tr>
  <tr>
    <td>
