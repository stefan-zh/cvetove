...
$id = $all['id'];
$title = $all['name'];
$lines .="<a href='admin.php?q=$q&opt=$id&method=full&issue=$issue' class='text-head' style='line-height:20px;'>$title</a><br />"; }
//-->
...
$info .= "<div id='main-box-header'>$name</div>
	<div id='main-box'><center><img src='../$img' class='art'></center>
	$text<br /><br /><br />
	<span class='author'>Aвтор: $author</span><br /><br /></div>
		<div id='box'>
		...
		<div id='box'>
		<div id='edit'>Предишни новини:<br /><br />$lines<br /></div>" ; }
