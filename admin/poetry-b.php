...
$qq = "Select * from `$mysql_table` where `main` = '2' and `issue` = '$issue'";
$req = mysql_query($qq);
...
$main = $row['main'];
if($main == '2') { $message = "[статията е главна]"; }
else { $message = "" ; }
...
$info .= "<div id='main-box-header'>$name <div class='boom'>$message</div></div>
	...
	<table width='100%' border='0' cellspacing='0' cellpadding='0'>
  		<tr>
    		...
    		<td>$text</b></i></u>... &nbsp;<br />
				<a href='admin.php?q=$q&opt=$id&method=full&issue=$issue' class='text-head'>[чети още]</a><br /><br /></td>
 		</tr>
	</table>
...
<?php echo($err); ?>
  <tr>
    <td><div id="main-head">Поезия</div></td>
  </tr>
  <tr>
    <td>
